...
import com.slokam.common.objects.BaseElement;
import com.slokam.common.utils.ApplicationProperties;
...
/*
    ...
    public boolean isElementPresent(com.slokam.common.By by) {
        try {
            ApplicationProperties.getInstance().disableWaitTime();
            return m_driver.findElement(by).isDisplayed();
        } catch (final NoSuchElementException e) {
